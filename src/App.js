...
function App() {
  return (
    <div className="App">
      ...
      <ul>
      <li>
      <p>Total overall height from the base of the pedestal foundation to the tip of the torch is <strong>305 feet, 6 inches</strong></p>
      </li>
      <li>
      <p>Height of the Statue from her heel to the top of her head is <strong>111 feet, 6 inches</strong></p>
      </li>
      <li>
      <p>The Statue has a <strong>35-foot</strong> waistline</p>
      </li>
      <li>
      <p>Total weight of the Statue of Liberty is <strong>225 tons</strong> (or <strong>450,000 pounds</strong>)</p>
      </li>
      </ul>
      </article>
    </div>
